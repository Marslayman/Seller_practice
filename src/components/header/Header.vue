...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .header
    ...
    .container-wrapper
      ...
      font-size: 0 /* 去除inlineblock元素之间的4px空白 */
      .avatar
      ...
      .content
        ...
        .title
          ...
          .brand
            ...
            width: 30px
            height: 18px
            bg-image("brand") /* mixin中通过函数实现背景图片根据dpr比例来做相应的大小调整 */
    ...
    .detail
      ...
      z-index: 999
      backdrop-filter: blur(10px) /* IOS底层filter blur效果的实现 */
      &.fade-enter
        opacity: 0
